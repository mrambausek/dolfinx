...
def test_matrix_assembly_block():
    ...
    bcs0 = dolfinx.cpp.fem.bcs_rows(
        dolfinx.fem.assemble._extract_test_spaces(dolfinx.fem.assemble._create_cpp_form(L_block)), [bc])
...
class NonlinearPDE_SNESProblem():
    ...
    def F_nest(self, snes, x, F):
        ...
        bcs1 = dolfinx.cpp.fem.bcs_cols(
            dolfinx.fem.assemble._extract_trial_spaces(dolfinx.fem.assemble._create_cpp_form(self.a)), self.bcs)
        ...
        # Set bc value in RHS
        bcs0 = dolfinx.cpp.fem.bcs_rows(
            dolfinx.fem.assemble._extract_test_spaces(dolfinx.fem.assemble._create_cpp_form(self.L)),
            self.bcs)
